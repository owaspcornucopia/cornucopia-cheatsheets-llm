...
A persistent pwnednext.db file, encrypted training memos, UserDefaults snapshots, model prompts, and in-process result state preserve sensitive data locally.
