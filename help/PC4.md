...
Unused camera, location, microphone, and photo-library usage descriptions remain in Info.plist even though the fraud workflow does not need those capabilities.
