...
The screen shows the full natural-language answer, while the copy action includes hidden SQL and rows. The Info.plist also keeps unused camera, location, microphone, and photo capability descriptions.
